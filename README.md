...
SYNAPTOR는 업로드한 학습 자료를 근거로 질문하고, 답변을 평가하고, 오개념을 교정하고, 사용자 상태에 맞는 다음 학습법과 복습 시점을 추천하는 **뇌과학 기반 개인화 AI 튜터**입니다.
...
기존 AI 학습 도구는 요약, 정답 제공, 단순 문제 생성에 치우치는 경우가 많습니다. SYNAPTOR는 다음 질문에 집중합니다.
...
DATABASE_URL=postgresql+psycopg://synaptor:synaptor_password@localhost:5432/synaptor
...
짧은 발표에서는 다음 흐름만 보여줘도 SYNAPTOR의 차별점이 드러납니다.
